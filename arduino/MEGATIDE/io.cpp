...
void mt_io_init(void)
{
    ...
    /*
     * The Arduino core normally uses Timer0 overflow for millis()/micros().
     * MEGATIDE is a fixed-function firmware and intentionally disables that
     * interrupt after taking ownership of Timer0.
     */
    TIMSK0 = 0u;
